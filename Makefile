...
#    Updated: 2022/11/09 15:54:40 by kdhrif           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = action_a.c action_b.c action_r.c ft_utils.c linked_list_0.c linked_list_1.c parsing_0.c parsing_1.c push_swap.c sorting_0.c sorting_1.c algo_0.c algo_1.c algo_2.c ft_split.c
OBJ = $(SRCS:%.c=%.o)
PRINTF = ./ft_printf
