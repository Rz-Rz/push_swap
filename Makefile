...
#    Updated: 2022/11/02 17:39:21 by kdhrif           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = action_a.c action_b.c action_r.c ft_utils.c linked_list_0.c linked_list_1.c parsing.c push_swap.c sorting_0.c sorting_1.c algo_0.c algo_1.c algo_2.c
OBJ = $(SRCS:%.c=%.o)
PRINTF = ./ft_printf
