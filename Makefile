...
#    Updated: 2022/10/29 15:41:57 by kdhrif           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = action_a.c action_b.c action_r.c ft_utils.c linked_list_0.c linked_list_1.c parsing.c push_swap.c sorting.c 
OBJ = $(SRCS:%.c=%.o)
PRINTF = ./ft_printf
