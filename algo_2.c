...
// Description: Compute the cost to put the corresponding node of target_pos to the top of stack_a.
// Input: node *node_b - the linked list to compute the cost in.
...
// Function: do_actions
// Description: Do the actions needed to put the node in stack_b in the right position in stack_a.
// Input: node *stack_b - the linked list to do the actions in.
